...
const courseColor = (idOrIndex, courses) => {
  if (idOrIndex === '__others') return 'oklch(0.55 0.02 250)';
  if (typeof idOrIndex === 'number') {
    return `oklch(0.72 0.14 ${COURSE_HUES[idOrIndex % COURSE_HUES.length]})`;
  }
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex relative">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute top-[15%] left-1/4 -translate-x-1/2 w-[600px] h-[500px] rounded-full"
        ...
        <div className="absolute top-[60%] left-[5%] w-[300px] h-[300px] rounded-full"
          style={{ background: 'radial-gradient(ellipse, rgba(56,189,248,0.05) 0%, transparent 65%)' }} />
      </div>
      ...
      <motion.div
        ...
        className="hidden md:flex flex-col items-start justify-center w-1/2 px-16 relative"
      >
        <motion.div
          initial={{ scale: 0.75, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ delay: 0.05, duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
          className="relative w-[72px] h-[72px] mb-8"
        >
          <div className="absolute inset-0 rounded-3xl bg-emerald-400/25 blur-2xl scale-110" />
          <div className="relative w-full h-full rounded-3xl bg-gradient-to-br from-emerald-500/25 to-teal-600/10 border border-emerald-500/35 grid place-items-center shadow-2xl shadow-emerald-900/30">
            <Icon name="GraduationCap" size={32} className="text-emerald-400" />
          </div>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.55 }}>
          <h1
            className="text-[58px] lg:text-[72px] font-bold tracking-[-0.03em] leading-none"
            style={{ background: 'linear-gradient(160deg, #f8fafc 0%, #e2e8f0 40%, #94a3b8 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}
          >
            Lattice
          </h1>
          <p className="mt-5 text-[15px] lg:text-[16px] text-slate-400 leading-[1.8] max-w-[380px]">
            Track your study sessions and understand exactly where your time goes.
          </p>
        </motion.div>
        ...
        >
          {features.map((f) => (
            <div key={f.title} className="flex items-start gap-3">
              <div className={`w-8 h-8 rounded-lg border ${f.iconBg} grid place-items-center shrink-0 shadow-sm`}>
                <Icon name={f.icon} size={14} className={f.iconColor} />
              </div>
              <div>
                <div className="text-[13px] font-semibold text-slate-200">{f.title}</div>
                <div className="text-[12px] text-slate-500 leading-relaxed mt-0.5">{f.desc}</div>
              </div>
            </div>
          ))}
        </motion.div>
      ...
      {/* Divider */}
      <div className="hidden md:block w-px bg-slate-800/60 my-12 self-stretch" />
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
        className="flex flex-col items-center justify-center w-full md:w-1/2 px-8 md:px-16 relative"
      >
        <div className="md:hidden mb-8 flex flex-col items-center">
          <div className="relative w-[60px] h-[60px] mb-4">
            <div className="absolute inset-0 rounded-3xl bg-emerald-400/25 blur-2xl scale-110" />
            <div className="relative w-full h-full rounded-3xl bg-gradient-to-br from-emerald-500/25 to-teal-600/10 border border-emerald-500/35 grid place-items-center shadow-2xl shadow-emerald-900/30">
              <Icon name="GraduationCap" size={26} className="text-emerald-400" />
            </div>
          </div>
          <h1
        ...
        <div className="w-full max-w-[340px] flex flex-col gap-3">
          <div className="mb-2">
            <div className="text-[20px] font-semibold text-slate-100">Hoş geldiniz</div>
            <div className="text-[13px] text-slate-500 mt-1">Devam etmek için giriş yapın</div>
          </div>

          <a
            href="/oauth2/authorization/google"
            className="flex items-center justify-center gap-3 px-7 py-3 rounded-xl bg-white hover:bg-gray-50 active:scale-95 text-gray-800 text-[14px] font-semibold transition-all shadow-xl shadow-black/25 border border-white/10"
          >
...
function CourseRail({
  ...
  const content = (
    <div className="h-full flex flex-col">
      ...
      <div className="px-5 pt-5 pb-4 flex items-center gap-2.5">
        <div className="w-7 h-7 rounded-md bg-emerald-500/15 border border-emerald-500/30 grid place-items-center">
          <Icon name="GraduationCap" size={15} className="text-emerald-400" />
        </div>
        <div className="flex-1 min-w-0">
          <div className="text-[13px] font-semibold text-slate-100 tracking-tight">Lattice</div>
          <div className="text-[11px] text-slate-500 -mt-0.5">Study tracker</div>
        </div>
  ...
  return (
    <>
      <aside className="hidden md:flex w-[260px] shrink-0 border-r border-slate-800/80 bg-slate-950/40 flex-col min-h-0">
        {content}
      </aside>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="md:hidden fixed left-0 top-0 bottom-0 w-[280px] bg-slate-950 border-r border-slate-800 z-50 flex flex-col"
            >
              {content}
            </motion.aside>
          </>
  ...
  return (
    <div className="rounded-xl border border-slate-800/80 bg-slate-900/40 overflow-hidden">
      ...
      <div className="relative px-5 py-10 grid place-items-center">
        ...
        <motion.div
          animate={sw.running ? { boxShadow: ['0 0 0 0 rgba(16,185,129,0.0)','0 0 0 8px rgba(16,185,129,0.08)','0 0 0 0 rgba(16,185,129,0.0)'] } : { boxShadow: '0 0 0 0 rgba(16,185,129,0)' }}
    ...
    <div className="flex flex-col h-full">
      <div className="px-6 pt-6 pb-4 border-b border-slate-800/60">
        ...
        <div className="mt-1.5 flex items-center justify-between gap-3">
          <h2 className="text-[20px] font-semibold text-slate-100 tracking-tight truncate flex items-center gap-2 group">
            <InlineRename
              value={course.name}
    ...
    <div className="p-5 md:p-8 space-y-6 max-w-[1280px] w-full mx-auto">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <h1 className="mt-1 text-[24px] md:text-[28px] font-semibold text-slate-100 tracking-tight">Stats</h1>
...
function TopBar({ onOpenMenu, course, topic, onBack, mobileView }) {
  return (
    <div className="md:hidden flex items-center gap-3 px-4 h-14 border-b border-slate-800/80 bg-slate-950/60 backdrop-blur">
      {mobileView === 'topics' && (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="min-w-0">
                        ...
                        <h1 className="mt-1 text-[24px] md:text-[28px] font-semibold text-slate-100 tracking-tight truncate">
